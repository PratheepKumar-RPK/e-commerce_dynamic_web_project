...
<!--Slide Banner -->
<img src="images/banner img/ceiling fan/cei b.png" class="img-fluid" alt="Wild Landscape"  style="padding-top: 70px;"/>
<!--Slide Banner -->
...
<div class="row row-cols-1 row-cols-md-3 g-4">
	<div class="col">
	  <div class="bg-image hover-zoom">
		<img src="images/New folder/ce1.png"  class="w-50 imgsize card-img-top" alt="Hollywood Sign on The Hill"/>
		<div class="card-body">
...
<div class="col">
	  <div class="bg-image hover-zoom">
		<img src="images/New folder/ce2.png"  class="w-50 imgsize card-img-top" alt="Hollywood Sign on The Hill"/>
		<div class="card-body">
			<div class="container1" >
				<a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
				<a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
	...
	<div class="col">
		<div class="bg-image hover-zoom">
		  <img src="images/New folder/ce3.png"  class="w-50 imgsize card-img-top" alt="Hollywood Sign on The Hill"/>
		  <div class="card-body">
			  <div class="container1" >
				  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
				  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>

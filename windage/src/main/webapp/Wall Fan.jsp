...
<!--Slide Banner -->
<img src="images/banner img/wall/wall b.png" class="img-fluid" alt="Wild Landscape"  style="padding-top: 70px;"/>
<!--Slide Banner -->
...
<div class="container">
<div class="row">
	<div class="col-md-8"><h3 style="color: #000B27; padding-top: 4%;"><b>Wall Fan</b></div>
	</h3>
	<p style="margin-top: 1%;">A category of fans suitable in rooms, lounges, seating areas, offices and all the places you can think of. What else can one ask for when it comes to location specific cooling. With major advantage of not consuming any floor space, the Havells range of wall fans come in a variety of world class designs and colors to add the missing element of style to your rooms.
	</p>
  </div>
</div>
<!--content-->
...
<div class="container">
	...
	<div class="row row-cols-1 row-cols-md-3 g-4">
		<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/wall/wall1.png"  class="imgsize card-img-top" style="width: 270px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
	...
	<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/wall/wall3.png"  class="imgsize card-img-top" style="width: 260px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
				<div class="container1" >
					<a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					<a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<div class="col">
			<div class="bg-image hover-zoom">
			  <img src="images/banner img/wall/wall2.png"  class="imgsize card-img-top" style="width: 260px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
			  <div class="card-body">
				  <div class="container1" >
					  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<%
									...
									<div class="col">
										<div class="bg-image hover-zoom">
										  <img src="images/banner img/wall/wall6.png"  class="imgsize card-img-top" style="width: 270px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
										  <div class="card-body">
											  <div class="container1" >
												  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
												  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>

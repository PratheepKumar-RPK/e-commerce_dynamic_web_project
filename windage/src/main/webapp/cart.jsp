        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
            <div class="card">
              ...
              <img src="images/wall fan/1.jpg"
                class="card-img-top" alt="Laptop" style="width: 200px;height: 270px; margin-left: 25%"/>
              <div class="card-body">
                <div class="d-flex justify-content-between">
                  <p class="small"><a href="#!" class="text-muted">Wall Fan</a></p>
                  <p class="small text-danger"><s>$1399</s></p>
                </div>
    
                <div class="d-flex justify-content-between mb-3">
                  <h5 class="mb-0">FAN 3</h5>

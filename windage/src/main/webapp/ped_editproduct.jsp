...
<form action="pedestal_fan_edit_quary.jsp" method="post" style="margin-top: 50px; width:  33%;">
          ...
          <%
                                try{
                    				...
                    				ResultSet ap=cd.executeQuery("Select * from pedestal_fan where id='"+productId+"'");

...
<!--Slide Banner -->
<img src="images/banner img/air cooler/air b.png" class="img-fluid" alt="Wild Landscape"  style="padding-top: 70px;"/>
<!--Slide Banner -->
...
<div class="container">
<div class="row">
	<div class="col-md-8"><h3 style="color: #000B27; padding-top: 4%;"><b>Air Cooler</b></div>
	</h3>
	<p style="margin-top: 1%;">Presenting windage unique range of air coolers for superior cooling to help you beat the heat this summer. With different tank capacities, they offer versatility for all your cooling needs. Experience excellent cooling efficiency using high-density Honeycomb or Wood Wool cooling pads. Crompton room coolers are packed with distinctive features like a wide-angle airflow for even cooling for large personal spaces, easy-to-clean ice chambers, and mosquito nets. Stay cool and refreshed with #JaldiCooling.
	</p>
  </div>
</div>
<!--content-->
...
<div class="container">
	...
	<div class="row row-cols-1 row-cols-md-3 g-4">
		<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/air cooler/air1.png"  class="imgsize card-img-top" style="width: 270px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
	...
	<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/air cooler/air2.png"  class="imgsize card-img-top" style="width: 210px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
				<div class="container1" >
					<a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					<a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<div class="col">
			<div class="bg-image hover-zoom">
			  <img src="images/banner img/air cooler/air3.png"  class="imgsize card-img-top" style="width: 210px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
			  <div class="card-body">
				  <div class="container1" >
					  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<%
									...
									<div class="col">
										<div class="bg-image hover-zoom">
										  <img src="images/banner img/air cooler/air5.png"  class="imgsize card-img-top" style="width: 210px;margin-left: 80px;" alt="Hollywood Sign on The Hill"/>
										  <div class="card-body">
											  <div class="container1" >
												  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
												  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>

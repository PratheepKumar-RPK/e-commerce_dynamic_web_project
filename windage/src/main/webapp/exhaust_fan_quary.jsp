...
String a="insert into exhaust_fan (id,Product_Name,Product_Sub_Name,Product_Spec,Product_detail,Product_Rate,Product_Discount) value(id,'"+Product_Name+"','"+Product_Sub_Name+"','"+Product_Spec+"','"+Product_Detail+"','"+Product_Rate+"','"+Product_Discount+"')";
...
if(i>0){
    %>
    <script>
        alert("Exhaust Fan Added Sucess");

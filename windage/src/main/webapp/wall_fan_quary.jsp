...
String a="insert into wall_fan (id,Product_Name,Product_Sub_Name,Product_Spec,Product_detail,Product_Rate,Product_Discount) value(id,'"+Product_Name+"','"+Product_Sub_Name+"','"+Product_Spec+"','"+Product_Detail+"','"+Product_Rate+"','"+Product_Discount+"')";

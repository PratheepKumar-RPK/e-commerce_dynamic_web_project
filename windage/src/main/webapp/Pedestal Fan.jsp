...
<!--Slide Banner -->
<img src="images/banner img/ped/ped b.png" class="img-fluid" alt="Wild Landscape"  style="padding-top: 70px;width: 100%;"/>
<!--Slide Banner -->
...
<div class="container">
	...
	<div class="row row-cols-1 row-cols-md-3 g-4">
		<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/ped/ped1.png"  class=" imgsize card-img-top" style="width: 300px;margin-left: 60px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
	...
	<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/ped/ped2.png"  class="imgsize card-img-top"  style="width: 300px;margin-left: 40px;"alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
				<div class="container1" >
					<a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					<a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<div class="col">
			<div class="bg-image hover-zoom">
			  <img src="images/banner img/ped/ped3.png"  class="imgsize card-img-top" style="width: 300px;margin-left: 18px;" alt="Hollywood Sign on The Hill"/>
			  <div class="card-body">
				  <div class="container1" >
					  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<%
									...
									<div class="col">
										<div class="bg-image hover-zoom">
										  <img src="images/banner img/ped/ped5.png"  class="imgsize card-img-top"  style="width: 300px;margin-left: 60px;" alt="Hollywood Sign on The Hill"/>
										  <div class="card-body">
											  <div class="container1" >
												  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
												  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>

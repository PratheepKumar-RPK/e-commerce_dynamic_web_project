...
<!--Slide Banner -->
<img src="images/banner img/exhaust/exhaust b.png" class="img-fluid" alt="Wild Landscape"  style="padding-top: 70px;"/>
<!--Slide Banner -->
...
<div class="container">
<div class="row">
	<div class="col-md-8"><h3 style="color: #000B27; padding-top: 4%;"><b>Exhaust Fan</b></div>
	</h3>
	<p style="margin-top: 1%;">A vital way of maintaining good health is appropriate air circulation. Good ventilation keeps bad odors, impurities and other unsafe gases away, and stops the formation of harmful mold inside your home. A proper ventilation device keeps your home away from unfortunate damage. Exhaust fans are a means to make sure the appropriate ventilation in your home. The major areas where it should be installed are the restroom as well as the kitchen as they usually contain most of the moisture and odors. Who likes to sit in room full of odors? You guessed it right, nobody. Presenting to you with the ideal solution to all your odors problems, The Havells range of domestic exhaust fans removes stale odors, leaving your rooms fresh and healthy. Their noiseless operation along with aesthetic looks, high utility and performance make these multipurpose machines a must have. With a sleek and trendy design, windage exhaust fans are lightweight and carry out their functions silently. These fans also last for a longer period as they have a rust proof body and blades. Though, it is essential that these fans are taken good care of so that they last and function for long. Provided that these fans perform an important function, it is required that every home has at least one installed in their kitchen as well as bathroom. You can simply search for the different fans price and reviews, and then proceed to purchase the best one online. Choose also from different shapes, sizes, colors and more.
	</p>
  </div>
</div>
<!--content-->
...
<div class="container">
	...
	<div class="row row-cols-1 row-cols-md-3 g-4">
		<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/exhaust/ext1.png"  class="imgsize card-img-top" style="height:200px; width: 200px;margin-left: 100px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
	...
	<div class="col">
		  <div class="bg-image hover-zoom">
			<img src="images/banner img/exhaust/ext2.png"  class="imgsize card-img-top" style="height:200px; width: 200px;margin-left: 100px;" alt="Hollywood Sign on The Hill"/>
			<div class="card-body">
				<div class="container1" >
					<a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					<a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<div class="col">
			<div class="bg-image hover-zoom">
			  <img src="images/banner img/exhaust/ext3.png"  class="imgsize card-img-top" style="height:200px; width: 200px;margin-left: 100px;" alt="Hollywood Sign on The Hill"/>
			  <div class="card-body">
				  <div class="container1" >
					  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
					  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
		...
		<%
									...
									<div class="col">
										<div class="bg-image hover-zoom">
										  <img src="images/banner img/exhaust/ext6.png"  class="imgsize card-img-top" style="height:200px; width: 200px;margin-left: 100px;" alt="Hollywood Sign on The Hill"/>
										  <div class="card-body">
											  <div class="container1" >
												  <a href=""><i style="color: #000B27 ;margin: 30px,0px,0px,100px; font-size: 20px;"class="fa-sharp fa-solid fa-heart-circle-plus"></i></a>
												  <a href=""><i style="color: #000B27 ; margin-top: 30px;font-size: 20px;"  class="fa-sharp fa-solid fa-share-nodes"></i></a>
